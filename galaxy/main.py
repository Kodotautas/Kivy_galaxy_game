...
from kivy.config import Config  #imports kivy configs file which allows to set default screen resolution
...
class MainWidget(RelativeLayout):
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_hame_has_started:
    ...
    def on_menu_button_pressed(self):
        ...
        self.reset_game()
        self.state_hame_has_started = True
